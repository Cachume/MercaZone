...
<head>
    ...
    <link rel="stylesheet" href="<?= APP_URL ?>/assets/css/dashboard.css?v=<?php echo time();?>">
            ...
            <div class="dashboard-datas">
                ...
                <div class="last-sellers">
                    ...
                    <table class="dashboard-products-table">
                        ...
                        <tbody id="ventas-recientes-body" class="dashboard-products-table-body">
                                <tr>
                                    <td>Iphone 17</td>
                                    <td>Albert Quintero</td>
                                </tr>
                        </tbody>
                    </table>
                </div>
            </div>
            <div class="dashboard-main-rig">
                <div class="rig-top-sellers">
                    ...
                    <table class="dashboard-products-table">
                        ...
                        <tbody id="products2-table-body" class="dashboard-products-table-body">
                                <tr>
                                    <td>
                                        <div class="buyer-info">
                                            <strong>María González</strong><br>
                                            <small>maria.gonzalez@example.com</small>
                                        </div>
                                    </td>
                                    <td>18 compras</td>
                                    <td>
                                        <button class="header-action-btn-table">
                                ...
                                <tr>
                                    <td>
                                        <div class="buyer-info">
                                            ...
                                            <small>carlos.ruiz@example.com</small>
                                        </div>
                                    </td>
                                    <td>12 compras</td>
                                    <td><button class="header-action-btn-table">
                                            <span class="material-symbols-outlined">percent</span>
                                        </button>  </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="buyer-info">
                                            <strong>Alejandra Pérez</strong><br>
                                            <small>ale.perez@example.com</small>
                                        </div>
                                    </td>
                                    <td>10 compras</td>
                                    <td><button class="header-action-btn-table">
