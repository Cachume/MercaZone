...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-10-2025 a las 13:35:50
...
(4, 2, 10, 3, 'pendiente', '2025-10-22 04:44:32'),
(5, 1, 10, 3, 'pendiente', '2025-10-22 04:46:54');
...
(1, 8, 'Xbox Controller Edicion Limitada', 1, 45.00, 7, 'controller.png', 45, 20, 'Controlador inalámbrico para Xbox', 'Controlador inalámbrico'),
(2, 8, 'Xbox Series X Galaxy Edition', 2, 400.00, 94, 'xbox.png', 45, 20, 'La Xbox Series X es la consola más potente de Microsoft, ofreciendo un rendimiento excepcional y gráficos de última generación.', 'Consola de videojuegos'),
...
(10, 'Albert', 'Colina', NULL, 'albertcolina22@gmail.com', '$2y$10$WpgXrm6DefMqbg98pDG7LOxpccmjUyK9.loBBv.Gu.d7dp1Zt5oO2', NULL, NULL, NULL, 'comprador', '2025-10-22 00:39:10', 0, 0, NULL);
